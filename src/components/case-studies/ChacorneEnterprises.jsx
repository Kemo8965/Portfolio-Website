    ...
    return (
        <div>
           ...
           <div class="flex flex-wrap lg:h-100 h-full py-20  bg-gray-100 sm:py-24 lg:py-16 pb-20 mb-20 lg:px-8 lg:ml-8 font-bold  text-3xl relative">
                        <img alt="gallery" className="w-full object-cover lg:h-100 h-full object-center block filter  brightness-50 absolute inset-0 " src="../assets/images/CE2.png" />
                        <div class="text-left ml-4 pt-10 lg:h-100 h-full relative  w-full">
                            <a href="#" >
                                <p className="text-gray-300 text-xl tracking-wide">Client</p>
                        <h1 class=" text-2xl text-gray-100 font-bold title-font mb-4 ">Chacorne Enterprises Limited </h1>
                        ...
                        <ol className="text-lg text-white">
                         ...
                         <a href='https://chacorne.com' class="mt-3 text-indigo-100 inline-flex text-lg items-center hover:text-blue-300">View Website
                ...
                <div className="flex flex-wrap lg:h-100 h-full py-28  bg-white sm:py-24 lg:py-16 pb-20 mb-20 lg:px-8 lg:mr-8   text-xl relative">
                    ...
                    <ol className="text-black text-xl ">
                        <li className="py-2">
                        How can potential customers find a company offering specific services in
                         construction of buildings & roads, fencing, electricals
...
export default ChacorneEnterprises
